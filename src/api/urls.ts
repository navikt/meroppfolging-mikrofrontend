...
const MEROPPFOLGING_BACKEND_API_URL: EnvUrl = {
  local: "http://localhost:3000/api/meroppfolging/mikrofrontend/v1/status",
  development: `https://www.intern.dev.nav.no/esyfo-proxy/api/meroppfolging/mikrofrontend/v1/status`,
  production: `https://www.nav.no/esyfo-proxy/api/meroppfolging/mikrofrontend/v1/status`,
};
